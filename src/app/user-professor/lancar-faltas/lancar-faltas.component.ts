...
export class LancarFaltasComponent implements OnInit {
  ...
  submitFormularioFalta(){
    ...
    console.log("teste");
    console.log(this.buscaDadosAlunosFaltosos.getAlunosFaltosos());
  }
  ...
  inicializaVariaveisSala(){
   ...
   buscaListaAlunosCadastrados(){
     ...
     console.log(this.listaAlunosCadastrados)
  ...
  chamaSala(){
    ...
    console.log(this.alunosDaDisciplina);
  }
}
